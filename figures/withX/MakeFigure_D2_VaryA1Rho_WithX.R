# MakeFigure_D2_VaryA1Rho_WithX.R
...
# ---- file prefix name ----
run_prefix <- "results/withX/D2/D2_varyA1Rho_withX_norm_n1000_it1000_seed314_20260605_201712"
...
agg$rho_facet <- factor(
  paste0("Corr(A,N)==", sprintf("%.2f", agg$rho_target)),
  levels = paste0("Corr(A,N)==", sprintf("%.2f", rho_levels))
)

agg$a1_facet <- factor(
  paste0("a[1]==", sprintf("%.2f", agg$a1)),
  levels = paste0("a[1]==", sprintf("%.2f", a1_levels))
)
