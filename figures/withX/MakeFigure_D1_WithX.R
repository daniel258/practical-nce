# MakeFigure_D1_WithX.R
# Two-panel figure for Design D1:
#   (A) mean NCE coefficient +/- SD
#   (B) power for H0: beta_N = 0
# Shown for Model 2 (Y~A+N) and Model 4 (Y~A+N+V)

# ---- file prefix name ----
run_prefix <- "results/withX/D1/D1_withX_norm_n1000_it1000_seed314_20260605_201312"
# reads: paste0(run_prefix, "_agg.csv")

# ---- output ----
out_dir  <- "figures/withX"
out_stem <- "Fig_D1_WithX"
