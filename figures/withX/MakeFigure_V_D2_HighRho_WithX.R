# MakeFigure_V_D2_HighRho_WithX.R
...
# Both shown for Model 2 (Y~A+Atilde + X1 + X2) and Model 4 (Y~A+Atilde+V + X1 + X2)
#
# Notes:
...
# ---- file prefix name ----
run_prefix <- "results/withX/withV/D2/withV_D2_highRho_withX_norm_n1000_it1000_seed314_20260303_163848"
