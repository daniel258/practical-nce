# MakeFigure_D0_t_Robust.R
# Requires: ggplot2

# ---- file prefix name ----
run_prefix <- "results/D0/D0_t_n1000_it1000_seed314_20260605_204641"
# Reads below: paste0(run_prefix, "_agg.csv")

# ---- output ----
out_dir  <- "figures"
out_stem <- "Fig_D0_t_Robust"
...
DrawCombined <- function() {
  ...
  grid::grid.text("Noise: t (df=3), Robust SE", vp = vp(3, 1:2), y = unit(0.85, "npc"))
