...
# Measured covariates affect A and Y, not N
ax_1 <- 0.15
ax_2 <- 0.15
bx_1 <- 0.2
bx_2 <- 0.2
...
tag <- sprintf("D1_withX_%s_n%d_it%d_seed%d", noise_dist, n_sample, n_iters, seed)
